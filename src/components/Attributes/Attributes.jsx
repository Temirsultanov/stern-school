...
const Attributes = ({ openCallBackModal }) => {
	...
	return (
		<div className='attributes' id='accomodations'>
					...
					<div className='block'>
						...
						<div className='right'>
							...
							<div className='column'>
								<h3>Размещение</h3>
								<p>
									Трех- и четырехместные номера, оборудованные комфортной мебелью (кровать с ортопедическим матрасом,
									тумбочка) и санузлом и душем в каждом номере.
								</p>
							</div>
						</div>
					</div>
