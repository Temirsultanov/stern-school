		...
		<div className='header'>
			<div className='header_top'>
				<div className='wrapper'>
					<NavLink to='/go' className='header_top_button'>
						Что взять с собой?
					</NavLink>
					<div className='info'>
					...
					<div className='icons'>
						<a target={'_blank'} href='https://wa.clck.bar/79365120601' className='image_wrapper' rel='noreferrer'>
						...
						<a target={'_blank'} href='https://t.me/shternik3' className='image_wrapper' rel='noreferrer'>
			...
			<div className='adaptive_header'>
				<div className='icons'>
					<a href='tel:+7 936 512-06-01' target={'_blank'} className='image_wrapper' rel='noreferrer'>
						<LazyLoadImage src='./images/header/phone.svg' width={'100%'} height={'100%'} alt='Image Alt' />
					</a>
					<a href='mailto:hi@stern.xyz' target={'_blank'} className='image_wrapper' rel='noreferrer'>
						<LazyLoadImage src='./images/header/mail.svg' width={'100%'} height={'100%'} alt='Image Alt' />
					</a>
					<a href='https://wa.clck.bar/79365120601' className='image_wrapper' target={'_blank'} rel='noreferrer'>
						<LazyLoadImage src='./images/header/whats.svg' width={'100%'} height={'100%'} alt='Image Alt' />
					</a>
					<a href='https://t.me/shternik3' target={'_blank'} className='image_wrapper' rel='noreferrer'>
						<LazyLoadImage src='./images/header/telegram.svg' width={'100%'} height={'100%'} alt='Image Alt' />
					</a>
				</div>
			...
			<div className={show ? 'burger_content show' : 'burger_content'}>
				<img src='./images/header/cross.svg' alt='' onClick={() => setShow(false)} />
