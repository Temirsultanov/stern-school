            ...
            <div className="wrapper">
                <div className="cont">
                    ...
                    <div className="row">
                        <div className="grid">
                            <div className="column">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Сандалии или босоножки (обязательно с
                                        фиксированной пяткой, чтобы избежать
                                        травм)
                                    </li>
                                    <li>
                            ...
                            <div className="grid_column">
                                ...
                                <div className="column">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Музыкальные инструменты, в т.ч. для
                                            выступления на шоу талантов
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="card">
                            <h6>Важно!</h6>
                            <p>Отдельно обращаем ваше внимание на то, что с целью обеспечения мер безопасности и охраны здоровья учащихся, категорически запрещен привоз любых скоропортящихся продуктов питания на территорию лагеря. МОжно дать с собой “сухой паек” в виде печенья, орехов и т.д. Это будет выдаваться детям в определенное время</p>
                        </div>
                    </div>
                </div>
            </div>
